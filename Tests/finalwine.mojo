...
fn main() raises:
    ...
    # SET K FOR KNN
    var K: Int = 5
    KMatrix = Matrix[5, 1]() # used for dynamic setting of variables (idk why this works)
    ...
    print("Predicted Classes for Wine:")
