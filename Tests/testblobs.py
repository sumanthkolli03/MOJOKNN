...
if __name__ == "__main__":
    data = np.loadtxt('blobsLarge.csv', delimiter=',')
    y = np.loadtxt('blobsLargeClasses.csv', delimiter=',')
    X = data


    training, testing, trainingclasses, y_test = train_test_split(X, y, train_size=0.996)
