...
if __name__ == "__main__":
    data = np.loadtxt('cover.csv', delimiter=',')
    y = np.loadtxt('coverClasses.csv', delimiter=',')
    X = data

    training, testing, trainingclasses, y_test = train_test_split(X, y, train_size=0.9904)
