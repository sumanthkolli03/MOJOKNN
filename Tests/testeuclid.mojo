...
fn main() raises:
    ...
    #69895
    training = Matrix[100000, 1000].rand() # HARDCODE IN HERE
    testing = Matrix[1000, 1].rand()


    ### MNIST DATA
    start_time = monotonic()
    distmatrix = Matrix[100000, 1]()

    distMatvec(training, testing, distmatrix)

    #runKNN(distmatrix, training, testing)
    ...
    print("Testing Euclidean Distance Calculations:")
    distmatrix.sprint()
