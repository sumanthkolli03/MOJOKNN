...
if __name__ == "__main__":
    data = np.loadtxt('fashion.csv', delimiter=',')
    y = np.loadtxt('fashionClasses.csv', delimiter=',')
    X = data

    training, testing, trainingclasses, y_test = train_test_split(X, y, train_size=0.9985)
