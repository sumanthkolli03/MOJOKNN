...
fn main() raises:
    ...
    dataraw, cols, rows = load_data(data="data.csv")
    featuresraw, _, __ = load_data(data='classes.csv')
    ...
    training.pprint()
    testing.pprint()
    trainingclasses.pprint()
    testingclasses.pprint()
    ...
    print("Predicted Classes for Iris:")
